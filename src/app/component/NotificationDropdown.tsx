...
const NotificationDropdown: React.FC<NotificationDropdownProps> = ({
  ...
  return (
    <div className="absolute  right-0 bottom-full mb-2 w-80 sm:w-96 bg-white rounded-md shadow-lg border border-gray-200 z-50 max-h-96 overflow-y-auto flex flex-col animate-fade-in-up">
      ...
      <div className="p-2 border-t border-gray-200 text-center sticky bottom-0 bg-white z-10 flex-shrink-0">
        <button
          onClick={onClose}
          className="text-xs text-indigo-600 hover:underline focus:outline-none cursor-pointer"
        >
          Đóng
        </button>
      </div>
