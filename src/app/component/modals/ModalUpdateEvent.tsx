...
const ModalUpdateEvent: React.FC<ModalUpdateEventProps> = ({
  ...
  }, [isOpen, internalAllUsers.length, internalRoles.length]);
    ...
    >
      ...
      >
        ...
        <div className="p-4 sm:p-6 overflow-y-auto">
          {isDataLoading &&
          (!internalAllUsers.length || !internalRoles.length) ? (
            ...
            <div className="text-center py-10">
              ...
              <p className="text-gray-500 mt-2">Vui lòng đóng và thử lại.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      {eventAvatarPreviewUrl || formData.avatarUrl ? (
                        ...
                        <div className="text-center p-2">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-8 w-8 sm:h-10 sm:w-10 mx-auto"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            strokeWidth={1.5}
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                {formData.organizers.map((organizer, index) => {
                  ...
                  const positionName =
                    selectedUser?.position?.name || "N/A (Chọn User)";
                  return (
                    <div
                      key={`org-${index}`}
                    ...
                    >
                      ...
                      <div className="flex justify-end">
                        <button
                          type="button"
                          onClick={() =>
                            handleRemoveMember("organizers", index)
                          }
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                {formData.participants.map((participant, index) => {
                  ...
                  const roleNameDisplay = isRoleFixedByProfile
                    ...
                    : roleOptions.find((r) => r.id === participant.roleId)
                        ?.name || "N/A";
                  return (
                    <div
                      key={`part-${index}`}
                    ...
                    >
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
                        ...
                        <div>
                          ...
                          {isRoleFixedByProfile ? (
                            ...
                            <SearchableDropdown
                              options={roleOptions}
                              selectedValue={roleForDisplayOrEdit}
                              onChange={(selectedId) =>
                                handleMemberChange(
                                  "participants",
                                  index,
                              ...
                              placeholder="-- Chọn hoặc tìm Vai trò --"
                              isLoading={isLoadingRoles}
                              disabled={isDataLoading || !participant.userId}
                            />
                          )}
                        </div>
                      </div>
                      <div className="flex justify-end">
                        <button
                          type="button"
                          onClick={() =>
                            handleRemoveMember("participants", index)
                          }
