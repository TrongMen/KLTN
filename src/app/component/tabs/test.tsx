...
tôi đã tách tab Sự kiện của tôi ra 1 file riểng như dưới đây:
"use client";
...
interface EventType {
  ...
  createdBy?: string;
  createdAt?: string;
  organizers?: { userId: string; fullName?: string; lastName?: string; firstName?: string; roleName?: string; positionName?: string; [key: string]: any }[];
  participants?: {
    userId: string;
    roleId?: string;
    roleName?: string;
