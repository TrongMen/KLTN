            ...
            <div className="md:col-span-1 space-y-4">
              {viewingEventDetails.avatarUrl ? (
                <Image
                  ...
                  alt={`Avatar cho ${viewingEventDetails.name}`}
                  width={200}
                  height={200}
                  className="rounded-lg object-cover border p-1 bg-white shadow-md mx-auto"
                />
              ) : (
                <div className="w-40 h-40 mx-auto rounded-lg bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center text-gray-400 text-5xl font-semibold border">
                  {viewingEventDetails.name?.charAt(0).toUpperCase() || "?"}
                </div>
              )}
              ...
              {viewingEventDetails.status === "REJECTED" &&
                viewingEventDetails.rejectionReason && (
                  <p className="text-red-600 text-center">
                    <strong className="font-medium text-red-800">Lý do:</strong>{" "}
                    {viewingEventDetails.rejectionReason}
                  </p>
                )}
            </div>
            <div className="md:col-span-2 space-y-3">
              <h4 className="text-lg font-semibold text-gray-700 border-b pb-1 mb-3">
                Chi tiết sự kiện
              </h4>
              <p>
              ...
              <p>
                <strong className="font-medium text-gray-700 w-28 inline-block align-top">
                  Mục đích:
                </strong>{" "}
          ...
          {events.map((event) => (
            ...
            >
              {event.avatarUrl ? (
                ...
                <div className="w-full h-40 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center text-gray-400 text-4xl font-semibold">
              ...
              <div className="p-4 flex-grow flex flex-col justify-between">
                  ...
                  <div className="space-y-1 text-sm text-gray-600 mb-3">
                    ...
                    {event.rejectionReason && event.status === "REJECTED" && (
                      <p className="flex items-start text-red-600">
                        <span className="mr-2 w-4 text-center pt-0.5">⚠️</span>
                ...
                <div className="flex flex-wrap justify-end items-center gap-2 pt-3 border-t border-gray-100 mt-auto">
                  <button
                    ...
                    title="Xem chi tiết"
                    className="px-3 py-1 cursor-pointer bg-gray-100 text-gray-700 text-xs rounded hover:bg-gray-200 transition-colors"
                  >
                    👁️ Chi tiết
                  </button>
                  {(currentUser?.id === event.createdBy ||
                    ...
                    <button
                      ...
                      className="px-3  py-1 cursor-pointer bg-blue-100 text-blue-700 text-xs rounded hover:bg-blue-200 transition-colors"
                    >
                      Sửa
                    </button>
                  )}
                    ...
                    event.status === "PENDING" && (
                      <>
                        ...
                        <button
                          ...
                          className="px-3 py-1 cursor-pointer bg-green-100 text-green-700 text-xs rounded hover:bg-green-200 transition-colors"
                        >
                          Duyệt
                        </button>{" "}
                        <button
